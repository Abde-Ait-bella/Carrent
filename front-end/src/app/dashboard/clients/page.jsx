                  ...
                  <Tooltip.Provider>
                    <Tooltip.Root>
                      <Tooltip.Trigger asChild>
                        <div>
                          {/* <button class='bg-purple-600 hover:bg-purple-700 active:bg-purple-600 px-5 py-2 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-purple font-medium text-white leading-5 transition-colors duration-150'>
                            Detailles
                          </button> */}
                          {/* <button className={`bg-[#2C5A96] ${poppins.className} hover:brightness-110 active:brightness-90 px-6 py-2 border-[#6083B7] border-b-[4px] hover:border-b-[6px] active:border-b-[2px] rounded-lg text-white transition-all hover:-translate-y-[1px] text-sm active:translate-y-[2px] cursor-pointer`}>
                          Detailles
                          </button> */}
                          {/* <button class={`group ${poppins.className} relative bg-[#1F4068] active:opacity-75 hover:brightness-150 px-4 py-[0.5rem] border border-[#2C5A96] text-sm hover:border-t-4 border-b-4 hover:border-b rounded-md outline-none overflow-hidden font-medium text-white duration-300`}>
                            <span class={`group-hover:top-[150%] ${poppins.className} inline-flex -top-[150%] left-0 absolute opacity-50 shadow-[#6083B7] shadow-[0_0_10px_10px_rgba(0,0,0,0.3)] rounded-md w-80 h-[5px] duration-500`}></span>
                            Detailles
                          </button> */}
