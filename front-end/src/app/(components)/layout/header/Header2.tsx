				...
				{/* <div className="top-bar top-bar-2 top-bar-3 @@bg">
					<div className="container-fluid">
						<div className="flex text-header-info">
							...
							<Link className="flex items-center pr-3 text-white email-head" href="/tel:123-456-7890">
						...
						<div className="text-header">
							<div className="text-unlock text-white text-sm-medium">More than <span className="text-primary">800+</span> special collection cars in this summer</div>
						...
						<div className="header-left">
							<div className="header-logo">
								<Link className="d-flex" href="/">
									<img className="h-12 light-mode h-[3rem]" alt="Carento" src="/assets/imgs/template/logo-d.svg" />
							...
							<div className="header-right">
								<div className="d-xxl-inline-block mr-15 align-middle d-none">
