...
//                         <th
//                           className={`px-4 py-3 text-lg ${quicksand.className}`}
//                         >
//                           Client
//                         </th>
//                         <th
...
//                               <div>
//                                 <p
//                                   className={` text-lg ${quicksand.className}`}
//                                 >
//                                   {d.user.name}
//                                 </p>
//                                 <p
...
//                           </td>
//                           <td
//                             className={`px-4 py-3 text-sm ${quicksand.className}`}
//                           >
//                             {d.final_price}{' '}
//                             <span className='text-bold'>DH</span>
//                           </td>
...
//                             class={`${currentPage == 1 ? 'bg-gray-300' : 'bg-gray-800 dark:hover:bg-gray-700 hover:bg-gray-900'} flex justify-center items-center   dark:bg-gray-800 ml-2 px-4 border-0 dark:border-gray-700 rounded h-10 font-medium text-white dark:hover:text-white dark:text-gray-400 text-base`}
//                           >
//                             <svg
//                               class='me-2 w-3.5 h-3.5 rtl:rotate-180'
//                               aria-hidden='true'
...
//                             onClick={() => setCurrentPage(p => p + 1)}
//                             class={`${currentPage == totalPages ? 'bg-gray-300' : 'bg-gray-800 dark:hover:bg-gray-700 hover:bg-gray-900'} flex justify-center items-center  dark:bg-gray-800 ml-2 px-4 border-0 dark:border-gray-700 rounded h-10 font-medium text-white dark:hover:text-white dark:text-gray-400 text-base`}
//                           >
//                             Next
//                             <svg
